package com.nhaowan.mobile.base.utils.cache;
...
public class ContentCache {
            ...
            if (mDiskLruCache == null || mDiskLruCache.isClosed()) {
                if ( diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > diskCacheSize) {
                    	...
                    	Log.e(TAG, getUsableSpace(diskCacheDir)+" free space <"+diskCacheSize + " "+diskCacheDir);
                    }
                }
            }
		...
		if(obj==null){
			new AsyncTask<String,Void,Object>(){
				...
				protected Object doInBackground(String... params) {
					Object obj=getContentFromDiskCache(params[0]);
					return obj;
				}
				@Override
	...
	public void removeContextFromMem(String context){
		HashMap<String,Object> contextMap=contextMaps.get(context);
		if(null==contextMap||contextMap.isEmpty())
			return;
		contextMap.clear();
	...
	public void removeContextFromMem(String context,String id){
		HashMap<String,Object> contextMap=contextMaps.get(context);
		if(null==contextMap||contextMap.isEmpty())
			return;
		contextMap.remove(id);
	}
	public void removeContextFromDisk(String context){
		HashMap<String,Object> contextMap=contextMaps.get(context);
		if(null==contextMap||contextMap.isEmpty())
			return;
		Iterator<String> iterator = contextMap.keySet().iterator();
		...
		while(iterator.hasNext()) {
			id=iterator.next();
			removeContextFromDisk(context,id);
		}
	}
	public void removeContextFromDisk(String context,String id){
		HashMap<String,Object> contextMap=contextMaps.get(context);
		if(null==contextMap||contextMap.isEmpty())
			return;
   ...
   //关闭缓存
	...
	private void writeObject(Object obj,OutputStream out){
		Object2FileUtils.writeObject(obj, out);
	}
	private Object readObject(InputStream is){
		return Object2FileUtils.readObject(is);
	}
